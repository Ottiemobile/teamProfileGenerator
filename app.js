...
function startHtml() {
    ...
    <body>
        ...
        <div class="container">
            <div class="row">`;
    fs.writeFile("./output/teampage.html", html, function(err) {
        if (err) {
            console.log(err);
        }
...
function addHtml(member) {
    return new Promise(function(resolve, reject) {
        ...
        fs.appendFile("./output/teampage.html", data, function (err) {
            if (err) {
                return reject(err);
            };
            return resolve();
...
function finishHtml() {
    ...
    fs.appendFile("./output/teampage.html", html, function (err) {
        if (err) {
            console.log(err);
        };
    });
